'''
This script is a collection of functions used to create 
excel files with column names: General Description, Taxon Name, Link
Caption Text, Specific Description, Collection, Height
and Photo Credits and multi-index of level 2 with the format
(1, A), (1,B)... where number represents figure_id and the 
letter is the label of a part of the Figure Illustration.
